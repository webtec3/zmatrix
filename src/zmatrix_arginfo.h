...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_im2col, 0, 0, 2)
    ZEND_ARG_TYPE_INFO(0, kernelHeight, IS_LONG, 0)
    ZEND_ARG_TYPE_INFO(0, kernelWidth, IS_LONG, 0)
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, strideHeight, IS_LONG, 0, "1")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, strideWidth, IS_LONG, 0, "1")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, paddingHeight, IS_LONG, 0, "0")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, paddingWidth, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_col2im, 0, 0, 3)
    ZEND_ARG_ARRAY_INFO(0, inputShape, 0)
    ZEND_ARG_TYPE_INFO(0, kernelHeight, IS_LONG, 0)
    ZEND_ARG_TYPE_INFO(0, kernelWidth, IS_LONG, 0)
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, strideHeight, IS_LONG, 0, "1")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, strideWidth, IS_LONG, 0, "1")
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_conv2d, 0, 0, 1)
    ZEND_ARG_OBJ_INFO(0, filters, ZMatrix\\ZTensor, 0)
    ZEND_ARG_OBJ_INFO_WITH_DEFAULT_VALUE(0, bias, ZMatrix\\ZTensor, 1, "null")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, strideHeight, IS_LONG, 0, "1")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, strideWidth, IS_LONG, 0, "1")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, paddingHeight, IS_LONG, 0, "0")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, paddingWidth, IS_LONG, 0, "0")
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_conv2d_backward, 0, 0, 2)
    ZEND_ARG_OBJ_INFO(0, gradOutput, ZMatrix\\ZTensor, 0)
    ZEND_ARG_OBJ_INFO(0, filters, ZMatrix\\ZTensor, 0)
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, strideHeight, IS_LONG, 0, "1")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, strideWidth, IS_LONG, 0, "1")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, paddingHeight, IS_LONG, 0, "0")
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_max_pool2d, 0, 0, 4)
    ZEND_ARG_TYPE_INFO(0, kernelHeight, IS_LONG, 0)
    ZEND_ARG_TYPE_INFO(0, kernelWidth, IS_LONG, 0)
    ZEND_ARG_TYPE_INFO(0, strideHeight, IS_LONG, 0)
    ZEND_ARG_TYPE_INFO(0, strideWidth, IS_LONG, 0)
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, paddingHeight, IS_LONG, 0, "0")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, paddingWidth, IS_LONG, 0, "0")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_max_pool2d_backward, 0, 0, 3)
    ZEND_ARG_OBJ_INFO(0, gradOutput, ZMatrix\\ZTensor, 0)
    ZEND_ARG_OBJ_INFO(0, indices, ZMatrix\\ZTensor, 0)
    ZEND_ARG_ARRAY_INFO(0, inputShape, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_permute, 0, 0, 1)
    ZEND_ARG_ARRAY_INFO(0, axes, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_flatten, 0, 0, 0)
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, startAxis, IS_LONG, 0, "0")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, endAxis, IS_LONG, 0, "-1")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_broadcast_to, 0, 0, 1)
    ZEND_ARG_ARRAY_INFO(0, shape, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_random_uniform, 0, 0, 4)
    ZEND_ARG_ARRAY_INFO(0, shape, 0)
    ZEND_ARG_TYPE_INFO(0, minimum, IS_DOUBLE, 0)
    ZEND_ARG_TYPE_INFO(0, maximum, IS_DOUBLE, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_sum_flex, 0, 0, 0)
    ZEND_ARG_INFO_WITH_DEFAULT_VALUE(0, axis, "null")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, keepDims, _IS_BOOL, 0, "false")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_mean_flex, 0, 0, 0)
    ZEND_ARG_INFO_WITH_DEFAULT_VALUE(0, axis, "null")
    ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, keepDims, _IS_BOOL, 0, "false")
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_fill, 0, 0, 1)
...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_ztensor_global_avg_pool2d, 0, 0, ZMatrix\\ZTensor, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_ztensor_global_avg_pool2d_backward, 0, 0, 2)
    ZEND_ARG_INFO(0, gradOutput)
    ZEND_ARG_TYPE_INFO(0, inputShape, IS_ARRAY, 0)
ZEND_END_ARG_INFO()
